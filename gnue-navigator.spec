...
spójny interfejs menu (w środowisku graficznym lub tekstowym) oparty
na XML-owej "definicji procesu". GNUe Navigator używa klientów GNUe
Forms lub GNUe Reports do uruchamiania właściwych formularzy i
raportów, więc odpowiednie narzędzia muszą być zainstalowane.
